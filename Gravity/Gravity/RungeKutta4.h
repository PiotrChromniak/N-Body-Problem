...
class RungeKutta4 {
  ...
  void move_particles(vector<Particle> &particles, int nth_derivative,
                      float dt);
  void copy_velocities_to_drdt(const vector<Particle> &particles);
  void calculate_first_dvdt(const vector<Particle> &particles);
  void calculate_nth_dvdt(const vector<Particle> &particles,
                          int nth_derivative);
  void calculate_nth_drdt(const vector<Particle> &particles, int nth_derivative,
                          float dt);
